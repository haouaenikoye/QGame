...
function setPreGame() {
    ...
    displayMsgToGameConsole("Appuyez  <img class=\"mini-controls\" src=\"images/play2.jpg\"> Pour commencer le jeu!");
}
...
function setToNewGame() {
    incrementGameBgNb();
    setToGame();
    displayMsgToGameConsole("Vous avez redémarré un jeu! Essayez de faire correspondre des paires pour révéler l'image cachée!");
}
...
function setToStopGame() {
    ...
    disableControl("stop");
    enableControl("playagain");
    displayMsgToGameConsole("Appuyez sur <img class=\"mini-controls\" src=\"images/playagain2.jpg\">  .");
    gs.AreCardsSelectable = false;
    gs.isGameStarted = false;
}
...
function setToGameWon() {
    setToStopGame();
    displayMsgToGameConsole("FELICITATION!!! BON BOULOT!");
}

...
function cardSelectedHandler(idLetStr) {
    ...
    if (!gs.AreCardsSelectable && !gs.isGameStarted) {
        alert("Appuyez sur PLAY pour démarrer une partie !");
    } else {
        ...
        if (card.isOnBoardBool && !card.isTurnedBool && gs.AreCardsSelectable) {
            ...
            //If its the second selected card
                ...
                //If cards dont match
                    ...
                    card.showGameImg();
                    displayMsgToGameConsole("Oups réessayer!");
                    disableControl("rejouer");
                    disableControl("stop");
